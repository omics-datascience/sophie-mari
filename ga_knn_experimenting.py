...
def fitness_function(individual, X, y):
    ...
    model = KNeighborsRegressor(n_neighbors=3)  # Use k=3 as per Table S8
...
# Set up the GA
def run_ga(X, y, num_generations=2000, population_size=5000, mutation_prob=0.2, crossover_prob=0.7, num_runs=100):
    """
    ...
    Parameters:
        ...
        num_runs (int): Number of independent GA/KNN runs to perform.
    ...
    toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.attr_bool, n=30)  # Chromosome length = 30
    ...
    # Perform independent GA/KNN runs
    for run in range(num_runs):
        # Initialize the population for this run
        ...
        # Get the best individual and its fitness score for this run
        best_individual = tools.selBest(population, 1)[0]
        best_fitness = best_individual.fitness.values[0]

        # Update the overall best individual and fitness if necessary
